...
public class Cities {
	...
	public Cities() {
		cities.add(new City("Start",new User("admin",false),0,0,0));
		cities.add(new City("Diyarbakir", tempUser, 1, 1500, 100));
		cities.add(new City("Tax",new User("admin",false),2,0,1000)); // user uzerınden çağır
		cities.add(new City("Batman", tempUser, 3, 2000, 200));
		cities.add(new City("Erzurum", tempUser, 4, 2800, 200));
		cities.add(new City("Lucky Card",new User("admin",false),5,0,0));//lucky card
		cities.add(new City("Van", tempUser, 6, 1800, 150));
		cities.add(new City("Hakkari", tempUser, 7, 700, 100));
		cities.add(new City("Jail",new User("admin",false),8,0,0)); // jail
		cities.add(new City("Trabzon", tempUser, 9, 2500, 200));
		cities.add(new City("Rize", tempUser, 10, 1800, 250));
		cities.add(new City("Lucky Card",new User("admin",false),11,0,0));//lucky card
		cities.add(new City("Tokat", tempUser, 12, 1800, 150));
		cities.add(new City("Extreme Card",new User("admin",false),13,0,0));//extream
		cities.add(new City("Tax",new User("admin",false),14,0,1000));//tax
		cities.add(new City("Ankara", tempUser, 15, 3500, 300));
		cities.add(new City("Teleport",new User("admin",false),16,0,0));//teleport
		cities.add(new City("Eskisehir", tempUser, 17, 2000, 150));
		cities.add(new City("Lucky Card",new User("admin",false),18,0,0));//lucky card
		...
		cities.add(new City("Go to Jail",new User("admin",false),24,0,0));//Go to jail
		cities.add(new City("Adana", tempUser, 25, 2800, 250));
		cities.add(new City("Lucky Card",new User("admin",false),5,0,0));//lucky
		...
		cities.add(new City("Extreme Card",new User("admin",false),30,0,0));//extreme card
