...
public class Cities {
	...
	public Cities() {
		...
		cities.add(new City("Batman", tempUser, 3, 2000, 150));
		cities.add(new City("Erzurum", tempUser, 4, 2800, 220));
		cities.add(new City("Lucky Card",new User("admin5",false),5,0,0));//lucky card
		cities.add(new City("Van", tempUser, 6, 1800, 130));
		cities.add(new City("Hakkari", tempUser, 7, 700, 50));
		cities.add(new City("Jail",new User("admin4",false),8,0,0)); // jail
		cities.add(new City("Trabzon", tempUser, 9, 2500, 200));
		cities.add(new City("Rize", tempUser, 10, 1800, 130));
		cities.add(new City("Lucky Card",new User("admin6",false),11,0,0));//lucky card
		cities.add(new City("Tokat", tempUser, 12, 1800, 140));
		...
		cities.add(new City("Kırıkkale", tempUser, 19, 1800, 140));
		cities.add(new City("Izmir", tempUser, 20, 3200, 270));
		cities.add(new City("Tax",new User("admin3",false),21,0,1000));//tax
		cities.add(new City("Denizli", tempUser, 22, 800, 40));
		cities.add(new City("Mugla", tempUser, 23, 1200, 70));
		cities.add(new City("Go to Jail",new User("admin9",false),24,0,0));//Go to jail
		cities.add(new City("Adana", tempUser, 25, 2800, 140));
		cities.add(new City("Lucky Card",new User("admin10",false),5,0,0));//lucky
		cities.add(new City("Antal	ya", tempUser, 27, 3200, 270));
		cities.add(new City("Mersin", tempUser, 28, 1500, 100));
		cities.add(new City("Istanbul", tempUser, 29, 4000, 350));
